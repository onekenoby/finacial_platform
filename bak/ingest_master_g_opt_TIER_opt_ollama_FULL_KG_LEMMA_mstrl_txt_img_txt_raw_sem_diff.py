    ...
    def process_page_worker(p_idx: int):
        ...
        try:
            ...
            if chunk_text and "NO_CONTENT" not in chunk_text and len(chunk_text) > 10:
                # FIX: Passiamo chunk_text puro per avere differenziazione tra raw e sem.
                # 'recurse_text_chunking' userà questo come 'text_raw'
                # e genererà internamente 'text_sem' aggiungendo l'header (Doc: ... | Pag: ...).
