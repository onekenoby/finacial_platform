    ...
    return rx.box(
        rx.vstack(
            rx.hstack(
                ...
                rx.text(rx.cond(is_bot, "AI Analyst", "Tu"), weight="bold"),
            ),
            rx.markdown(msg.content),
            align_items="start", width="100%"
        ),
        bg=rx.cond(is_bot, rx.color("gray", 3), rx.color("indigo", 9)),
        color=rx.cond(is_bot, "black", "white"),
        padding="1em", border_radius="10px", margin_y="0.5em", width="100%", align_self=rx.cond(is_bot, "start", "end")
    )
